...
describe('Test Import Manager: src/apigateway/import-manager/index.js', () => {
    it('should return true for directory', () => {
        const path = 'test/mocks/apigateway/mock-directory-handlers/base';
        const manager = new ImportManager();
        const result = manager.isDirectory(path);
        assert.equal(result, true);
    });
    it('should return false for directory', () => {
        const path = 'test/mocks/apigateway/mock-directory-handlers/base/{base-id}.js';
        const manager = new ImportManager();
        const result = manager.isDirectory(path);
    ...
    it('should find path paramater directory', () => {
        const path = 'test/mocks/apigateway/mock-directory-handlers/params';
        const manager = new ImportManager();
